...
fenetre_depot::fenetre_depot()
{

    //Instanciation des widgets
    this->soldeDisponible = new QLabel("Vous disposez de x €", this);
    this->montant = new QLabel("Montant à déposer :", this);
...
void fenetre_depot::process_depot()
{
    /**Code permettant d'ajouter le montant saisie au solde
